...
class EmailConfirmationManager:
    ...
    def send_mail(self, template: str, confirm_url: str,
                  from_email: str, subject: Optional[str] = 'تایید ایمیل',
                  plain_message: Optional[str] = None) -> bool:
        ...
        Args:
            ...
            subject (Optional[str], optional): Email subject. Defaults to 'تایید ایمیل'.
            plain_message (Optional[str], optional): Plain text message. Defaults to None.
        ...
        if not plain_message:
            plain_message = (f"سلام {self.user.get_full_name()} عزیز، " +
